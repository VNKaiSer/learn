...
### 2. Thiết lập cấu hình kết nối (Nếu cần)

Mặc định, dự án đang kết nối tới URL RabbitMQ thử nghiệm trong mã nguồn:

```typescript
const RABBIRMQ_URL = "amqp://kasier:4S12H2afTB5y@46.250.231.89:5672";
```

_(Bạn có thể thay đổi URL này nếu muốn chạy trên RabbitMQ local hoặc server khác)._
